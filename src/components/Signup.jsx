...
const Signup = () => {
    ...
    const register = (e) => {
        ...
        if (password == rePassword) {
            ...
            setSignupStatus("Both the Passwords are not mached!!!")
        }
    };
            ...
            <div className="wrapperSignup">
                <div className="boxSignup">
                    ...
                    <div className="footerBoxSignup">
                        ...
                        <p className="dangerMsg">{signupStatus}</p>
                        ...
                        <input type="text" className="login-input" placeholder="Mobile Number" onChange={(e) => { setMobile(e.target.value); }} required />
